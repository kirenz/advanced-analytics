...
To combine the data preparation with the model building, we alternatively could use the package [workflows](https://workflows.tidymodels.org). 
...
We can also `prep()` the `recipe()`. This means we actually do something with the steps and our training data.
